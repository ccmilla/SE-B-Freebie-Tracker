...
Freebie.create(item_name: "pencil", item_value: 1, company_id:google.id, dev_id: morty.id)
Freebie.create(item_name: "sticker", item_value: 2, company_id:google.id, dev_id: gaz.id)
